...
router.route('/:classId/assignments/:assignmentId')
  .get(controller.getAssignment)
  .patch(controller.updateOne);

router.route('/:classId/assignments/:assignmentId/submissions')
  .get(controller.submissions)
  .post(controller.createSubmission);

router.route('/:classId/assignments/:assignmentId/submissions/:submissionId')
